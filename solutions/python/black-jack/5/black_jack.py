...
def value_of_ace(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    is_ace = 'A' in [card_one, card_two]
    
    if not is_ace and value_of_card(card_one) + value_of_card(card_two) < 11:
        return 11
    return 1
...
def is_blackjack(card_one, card_two):
    ...
    if not is_ace:
        ...
        if card_one == 'A':
            sum_of_cards = 11 + value_of_card(card_two)
        elif card_two == 'A':
            sum_of_cards = 11 + value_of_card(card_one)
